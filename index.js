...
const suma = ("/suma",(req, res) => {
    ...
    res.send(`SUMA: ${sumando1} + ${sumando2} = ${sumacion}`)
})
...
const resta = ("/resta",(req, res) => {
    ...
    res.send(`RESTA: ${restando1} - ${restando2} = ${restacion}`)
})
...
const multi = ("/multi",(req, res) => {
    ...
    res.send(`MULTIPLICA: ${multi1} x ${multi2} = ${multacion}`)
})
...
const divide = ("/divide",(req, res) => {
    ...
    res.send(`DIVISIÓN: ${divide1} / ${divide2} = ${division}`)
})
...
const potencia = ("/potencia",(req, res) => {
    ...
    res.send(`POTENCIA: ${base} elevado a ${potenciador} = ${resultado}`)
})
